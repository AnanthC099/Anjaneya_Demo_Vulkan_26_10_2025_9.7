...
cl.exe /c /EHsc /I C:\VulkanSDK\Anjaneya\Include SceneSwitcher.cpp Scene0.cpp Scene1.cpp Scene2.cpp

rc.exe Scene0.rc

link.exe  SceneSwitcher.obj Scene0.obj Scene1.obj Scene2.obj Scene0.res /LIBPATH:C:\VulkanSDK\Anjaneya\Lib /SUBSYSTEM:WINDOWS
